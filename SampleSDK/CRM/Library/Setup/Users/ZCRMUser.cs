...
namespace SampleSDK.CRM.Library.Setup.Users
{
    public class ZCRMUser : ZCRMEntity
    {
        ...
        //Note: Inspect the usage of the property in java(because it's name is isConfirmed);
        ...
        //TODO: Write FileResponse DownloadProfilePic() and FileResponse DownloadProfilePic(<With_necessary_parameter>) methods;
    }
}
